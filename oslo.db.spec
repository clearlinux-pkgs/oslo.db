...
Version  : 4.18.0
Release  : 51
URL      : http://tarballs.openstack.org/oslo.db/oslo.db-4.18.0.tar.gz
Source0  : http://tarballs.openstack.org/oslo.db/oslo.db-4.18.0.tar.gz
Source99 : http://tarballs.openstack.org/oslo.db/oslo.db-4.18.0.tar.gz.asc
...
%prep
%setup -q -n oslo.db-4.18.0
%patch1 -p1

%build
export LANG=C
export SOURCE_DATE_EPOCH=1489784295
